...
from openpilot.frogpilot.common.frogpilot_utilities import calculate_distance_to_point, frogpilot_api_post
...
class WeatherChecker:
  ...
  def update_weather(self, gps_position, now, frogpilot_toggles):
    ...
    future = self.executor.submit(frogpilot_api_post, "/v1/weather", payload)
